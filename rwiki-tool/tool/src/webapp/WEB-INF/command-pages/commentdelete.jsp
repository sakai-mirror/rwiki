...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page" version="2.0" 
  ...
  <div class="rwiki_help_popup" >
	    ...
	    <nobr><c:out value="${rlb.jsp_delete_comment_confirm}"/></nobr><br/>
		...
		<span class="act">
			<jsp:element name="input">
				...
				<jsp:attribute name="name">delete</jsp:attribute>
				<jsp:attribute name="value"><c:out value="${rlb.jsp_button_yes}" /></jsp:attribute>
			</jsp:element>
			<jsp:element name="input">
				<jsp:attribute name="type">button</jsp:attribute> 
				<jsp:attribute name="onclick">popupClose(-1);</jsp:attribute>
				<jsp:attribute name="value"><c:out value="${rlb.jsp_button_no}" /></jsp:attribute>
			</jsp:element>
		</span>
		</nobr>
	    </form>
